  ...
  <div class="pb-10">
    ...
    <div class="space-y-6" v-else>
      ...
      <ClientOnly>
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p
                  ...
                  :class="
                    activeOutlet?.is_open ? 'text-green-600' : 'text-red-600'
                  "
                >
                  {{
                    activeOutlet?.is_open
        ...
        <template #fallback>
          <Skeleton
            class="h-[74px] w-full rounded-[1.5rem] border border-border/50"
          />
        </template>
      </ClientOnly>
        ...
        <ClientOnly>
          ...
          >
            ...
            >
              <div class="flex items-center gap-3">
                <div
                  class="size-9 rounded-xl bg-secondary flex items-center justify-center text-foreground border border-border transition-transform group-active:scale-90"
                >
                  <Icon
                    :name="
          ...
          <template #fallback>
            <Skeleton
              class="h-[139px] w-full rounded-[1.5rem] border border-border/50"
            />
          </template>
        </ClientOnly>
      </div>
